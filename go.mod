...
replace (
	github.com/huanggengzhong/go-gin-example/conf => /Users/luogengzhong/Documents/study/01-go-learn/11-go-gin-example/conf
	github.com/huanggengzhong/go-gin-example/docs => /Users/luogengzhong/Documents/study/01-go-learn/11-go-gin-example/docs
